...
static void rt_hw_i2c_pinmux_config(void)
{
#ifdef BSP_USING_I2C0
#ifdef I2C0_SCL_USING_IIC0_SCL
    PINMUX_CONFIG(IIC0_SCL, IIC0_SCL);
#elif defined(I2C0_SCL_USING_PAD_MIPIRX4N)
    PINMUX_CONFIG(PAD_MIPIRX4N, IIC0_SCL);
#else
    LOG_E("IIC0_SCL pinmux config failed");
#endif

#ifdef I2C0_SDA_USING_IIC0_SDA
    PINMUX_CONFIG(IIC0_SDA, IIC0_SDA);
#elif defined(I2C0_SDA_USING_PAD_MIPIRX4P)
    PINMUX_CONFIG(PAD_MIPIRX4P, IIC0_SDA);
#else
    LOG_E("IIC0_SDA pinmux config failed");
#endif

#endif /* BSP_USING_I2C0 */

#ifdef BSP_USING_I2C1
#ifdef I2C1_SCL_USING_PAD_MIPIRX4P
    PINMUX_CONFIG(PAD_MIPIRX4P, IIC1_SCL);
#elif defined(I2C1_SCL_USING_PAD_MIPIRX0N)
    PINMUX_CONFIG(PAD_MIPIRX0N, IIC1_SCL);
#elif defined(I2C1_SCL_USING_SD1_D3)
    PINMUX_CONFIG(SD1_D3, IIC1_SCL);
#elif defined(I2C1_SCL_USING_MUX_SPI1_MOSI)
    PINMUX_CONFIG(MUX_SPI1_MOSI, IIC1_SCL);
#elif defined(I2C1_SCL_USING_PAD_ETH_TXP___EPHY_RXN)
    PINMUX_CONFIG(PAD_ETH_TXP___EPHY_RXN, IIC1_SCL);
#elif defined(I2C1_SCL_USING_PAD_SD0_CMD)
    PINMUX_CONFIG(SD0_CMD, IIC1_SCL);
#elif defined(I2C1_SCL_USING_SD0_D2)
    PINMUX_CONFIG(SD0_D2, IIC1_SCL);
#elif defined(I2C1_SCL_USING_SD1_D2)
    PINMUX_CONFIG(SD1_D2, IIC1_SCL);
#elif defined(I2C1_SCL_USING_PAD_MIPI_TXP2)
    PINMUX_CONFIG(PAD_MIPI_TXP2, IIC1_SCL);
#elif defined(I2C1_SCL_USING_VIVO_D9)
    PINMUX_CONFIG(VIVO_D9, IIC1_SCL);
#elif defined(I2C1_SCL_USING_VIVO_D3)
    PINMUX_CONFIG(VIVO_D3, IIC1_SCL);
#elif defined(I2C1_SCL_USING_PAD_MIPI_TXP4)
    PINMUX_CONFIG(PAD_MIPI_TXP4, IIC1_SCL);
#elif defined(I2C1_SCL_USING_PAD_MIPI_TXP3)
    PINMUX_CONFIG(PAD_MIPI_TXP3, IIC1_SCL);
#else
    LOG_E("IIC1_SCL pinmux config failed");
#endif

#ifdef I2C1_SDA_USING_PAD_MIPIRX4N
    PINMUX_CONFIG(PAD_MIPIRX4N, IIC1_SDA);
#elif defined(I2C1_SDA_USING_PAD_MIPIRX1P)
    PINMUX_CONFIG(PAD_MIPIRX1P, IIC1_SDA);
#elif defined(I2C1_SDA_USING_SD1_D0)
    PINMUX_CONFIG(SD1_D0, IIC1_SDA);
#elif defined(I2C1_SDA_USING_MUX_SPI1_MISO)
    PINMUX_CONFIG(MUX_SPI1_MISO, IIC1_SDA);
#elif defined(I2C1_SDA_USING_PAD_ETH_TXM___EPHY_RXP)
    PINMUX_CONFIG(PAD_ETH_TXM___EPHY_RXP, IIC1_SDA);
#elif defined(I2C1_SDA_USING_SD0_CLK)
    PINMUX_CONFIG(SD0_CLK, IIC1_SDA);    
#elif defined(I2C1_SDA_USING_SD0_D1)
    PINMUX_CONFIG(SD0_D1, IIC1_SDA);
#elif defined(I2C1_SDA_USING_SD1_D1)
    PINMUX_CONFIG(SD1_D1, IIC1_SDA);
#elif defined(I2C1_SDA_USING_PAD_MIPI_TXM2)
    PINMUX_CONFIG(PAD_MIPI_TXM2, IIC1_SDA);
#elif defined(I2C1_SDA_USING_VIVO_D10)
    PINMUX_CONFIG(VIVO_D10, IIC1_SDA);
#elif defined(I2C1_SDA_USING_VIVO_D4)
    PINMUX_CONFIG(VIVO_D4, IIC1_SDA);
#elif defined(I2C1_SDA_USING_PAD_MIPI_TXM4)
    PINMUX_CONFIG(PAD_MIPI_TXM4, IIC1_SDA);
#elif defined(I2C1_SDA_USING_PAD_MIPI_TXM3)
    PINMUX_CONFIG(PAD_MIPI_TXM3, IIC1_SDA);
#else
    LOG_E("IIC1_SDA pinmux config failed");
#endif
#endif /* BSP_USING_I2C1 */

#ifdef BSP_USING_I2C2
#ifdef I2C2_SCL_USING_PAD_MIPI_TXP1
    PINMUX_CONFIG(PAD_MIPI_TXP1, IIC2_SCL);
#elif defined(I2C2_SCL_USING_PWR_GPIO1)
    PINMUX_CONFIG(PWR_GPIO1, IIC2_SCL);
#elif defined(I2C2_SCL_USING_PAD_MIPI_TXP3)
    PINMUX_CONFIG(PAD_MIPI_TXP3, IIC2_SCL);
#elif defined(I2C2_SCL_USING_IIC2_SCL)
    PINMUX_CONFIG(IIC2_SCL, IIC2_SCL);
#elif defined(I2C2_SCL_USING_VIVO_D8)
    PINMUX_CONFIG(VIVO_D8, IIC2_SCL);    
#else
    LOG_E("IIC2_SCL pinmux config failed");
#endif

#ifdef I2C2_SDA_USING_PAD_MIPI_TXM1
    PINMUX_CONFIG(PAD_MIPI_TXM1, IIC2_SDA);
#elif defined(I2C2_SDA_USING_PWR_GPIO2)
    PINMUX_CONFIG(PWR_GPIO2, IIC2_SDA);
#elif defined(I2C2_SDA_USING_PAD_MIPI_TXM3)
    PINMUX_CONFIG(PAD_MIPI_TXM3, IIC2_SDA);
#elif defined(I2C2_SDA_USING_IIC2_SDA)
    PINMUX_CONFIG(IIC2_SDA, IIC2_SDA);
#elif defined(I2C2_SDA_USING_VIVO_D7)
    PINMUX_CONFIG(VIVO_D7, IIC2_SDA);
#else
    LOG_E("IIC2_SDA pinmux config failed");
#endif
#endif /* BSP_USING_I2C2 */

#ifdef BSP_USING_I2C3
#ifdef I2C3_SCL_USING_SD1_CMD
    PINMUX_CONFIG(SD1_CMD, IIC3_SCL);
#elif defined(I2C3_SCL_USING_VIVO_D0)
    PINMUX_CONFIG(VIVO_D0, IIC3_SCL);
#elif defined(I2C3_SCL_USING_SD1_CMD)
    PINMUX_CONFIG(IIC3_SCL, IIC3_SCL);
#else
    LOG_E("IIC3_SCL pinmux config failed");
#endif

#ifdef I2C3_SDA_USING_SD1_CLK
    PINMUX_CONFIG(SD1_CLK, IIC3_SDA);
#elif defined(I2C3_SDA_USING_VIVO_D1)
    PINMUX_CONFIG(VIVO_D1, IIC3_SDA);
#elif defined(I2C3_SDA_USING_IIC3_SDA)
    PINMUX_CONFIG(IIC3_SDA, IIC3_SDA);
#else
    LOG_E("IIC3_SDA pinmux config failed");
#endif
#endif /* BSP_USING_I2C3 */

#ifdef BSP_USING_I2C4
#ifdef I2C4_SCL_USING_PAD_MIPIRX2N
    PINMUX_CONFIG(PAD_MIPIRX2N, IIC4_SCL);
#elif defined(I2C4_SCL_USING_PWR_WAKEUP0)
    PINMUX_CONFIG(PWR_WAKEUP0, IIC4_SCL);
#elif defined(I2C4_SCL_USING_ADC3)
    PINMUX_CONFIG(ADC3, IIC4_SCL);
#elif defined(I2C4_SCL_USING_CAM_RST0)
    PINMUX_CONFIG(CAM_RST0, IIC4_SCL);
#elif defined(I2C4_SCL_USING_PWR_WAKEUP1)
    PINMUX_CONFIG(PWR_WAKEUP1, IIC4_SCL);
#elif defined(I2C4_SCL_USING_VIVO_D1)
    PINMUX_CONFIG(VIVO_D1, IIC4_SCL);
#else
    LOG_E("IIC4_SCL pinmux config failed");
#endif

#ifdef I2C4_SDA_USING_PAD_MIPIRX2P
    PINMUX_CONFIG(PAD_MIPIRX2P, IIC4_SDA);
#elif defined(I2C4_SDA_USING_PWR_BUTTON1)
    PINMUX_CONFIG(PWR_BUTTON1, IIC4_SDA);
#elif defined(I2C4_SDA_USING_ADC2)
    PINMUX_CONFIG(ADC2, IIC4_SDA);
#elif defined(I2C4_SDA_USING_CAM_PD1)
    PINMUX_CONFIG(CAM_PD1, IIC4_SDA);
#elif defined(I2C4_SDA_USING_PWR_ON)
    PINMUX_CONFIG(PWR_ON, IIC4_SDA);
#elif defined(I2C4_SDA_USING_VIVO_D0)
    PINMUX_CONFIG(VIVO_D0, IIC4_SDA);
#else
    LOG_E("IIC4_SDA pinmux config failed");
#endif
#endif /* BSP_USING_I2C4 */
}
